...
```{r}
#read data
B44 <- read.csv("PeaceAssay/2024-08-09_PeaceAssay_B44.csv", na.strings = "na") 
...
### Loop for running analysis for each day separately
...
```{r}
#read data
B30 <- read.csv("PeaceAssay/2024-07-21_PeaceAssay_B30.csv", na.strings = "na") 
...
```{r}
#read data
B5 <- read.csv("PeaceAssay/2024-08-09_PeaceAssay_B5.csv", na.strings = "na") 
...
```{r}
#read data
AL65 <- read.csv("PeaceAssay/2024-08-09_PeaceAssay_AL65.csv", na.strings = "na") 
#load cbb color palette
cbbPalette <- c("#000000", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7")
str(AL65)
#round off of the distance to yeast so that it is visibly a categorical variable
...
```{r}
#read data
B17 <- read.csv("PeaceAssay/2024-07-17_PeaceAssay_B17.csv", na.strings = "na") 
...
```{r}
#read data
B52 <- read.csv("PeaceAssay/MergedB52.csv", na.strings = "na") 
#load cbb color palette
cbbPalette <- c("#000000", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7")
str(B52)
#round off of the distance to yeast so that it is visibly a categorical variable
